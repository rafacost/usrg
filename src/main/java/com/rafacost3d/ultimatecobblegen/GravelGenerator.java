...
public class GravelGenerator extends Block implements ITileEntityProvider {

    static final ResourceLocation RS = new ResourceLocation(UltimateCobbleGen.MODID, "gravelgenerator");
    static final GravelGenerator BLOCK = new GravelGenerator();
    ...
    public static class Tile extends TileEntity implements IItemHandler {
        ...
        public ItemStack getStackInSlot(int slot) {
            return new ItemStack(Blocks.GRAVEL, getMaxCobble());
        }
        ...
        public ItemStack extractItem(int slot, int amount, boolean simulate) {
            ...
            return new ItemStack(Blocks.GRAVEL, amt);
        }
