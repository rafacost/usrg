...
public class SandGenerator extends Block implements ITileEntityProvider {

    static final ResourceLocation RS = new ResourceLocation(UltimateCobbleGen.MODID, "sandgenerator");
    static final SandGenerator BLOCK = new SandGenerator();
    ...
    public static class Tile extends TileEntity implements IItemHandler {
        ...
        public ItemStack getStackInSlot(int slot) {
            return new ItemStack(Blocks.SAND, getMaxCobble());
        }
