...
public class GrassGenerator extends Block implements ITileEntityProvider {

    static final ResourceLocation RS = new ResourceLocation(UltimateCobbleGen.MODID, "grassgenerator");
    static final GrassGenerator BLOCK = new GrassGenerator();
    ...
    public static class Tile extends TileEntity implements IItemHandler {
        ...
        public ItemStack getStackInSlot(int slot) {
            return new ItemStack(Blocks.GRASS, getMaxCobble());
        }
        ...
        public ItemStack extractItem(int slot, int amount, boolean simulate) {
            ...
            return new ItemStack(Blocks.GRASS, amt);
        }
