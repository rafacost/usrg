...
public class FungusGenerator extends Block implements ITileEntityProvider {

    static final ResourceLocation RS = new ResourceLocation(UltimateCobbleGen.MODID, "fungusgenerator");
    static final FungusGenerator BLOCK = new FungusGenerator();
    ...
    public static class Tile extends TileEntity implements IItemHandler {
        ...
        public ItemStack getStackInSlot(int slot) {
            return new ItemStack(Blocks.MYCELIUM, getMaxCobble());
        }
        ...
        public ItemStack extractItem(int slot, int amount, boolean simulate) {
            ...
            return new ItemStack(Blocks.MYCELIUM, amt);
        }
