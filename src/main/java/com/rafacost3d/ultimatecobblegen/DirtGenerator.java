...
public class DirtGenerator extends Block implements ITileEntityProvider {

    static final ResourceLocation RS = new ResourceLocation(UltimateCobbleGen.MODID, "dirtgenerator");
    static final DirtGenerator BLOCK = new DirtGenerator();
    ...
    public static class Tile extends TileEntity implements IItemHandler {
        ...
        public ItemStack getStackInSlot(int slot) {
            return new ItemStack(Blocks.DIRT, getMaxCobble());
        }
        ...
        public ItemStack extractItem(int slot, int amount, boolean simulate) {
            ...
            return new ItemStack(Blocks.DIRT, amt);
        }
